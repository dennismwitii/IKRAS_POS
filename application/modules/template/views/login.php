...
body {
  ...
  background-size: 700px 300px;
    ...
    <body background="assets/img/icons/background.png">
        <!-- Content Wrapper -->
   ...
   <div class="panel panel-bd">
                        ...
                        <div class="view-header">
                         <div class="header-icon">
                           ...
                           <!-- <img src="assets/img/icons/mini-logo.png" alt="">-->
                             <div class="header-title">
                               <h3><?php echo (!empty($setting->title)?$setting->title:null) ?><strong>IKRAS Point of Sale</strong></h3><br>
                                <small><h3><?php echo display('login') ?><strong></strong></h3></small>
